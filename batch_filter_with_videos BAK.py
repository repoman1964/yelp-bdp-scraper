...
for csv_file in csv_with_screenshots:
    ...
    csv_df = pd.read_csv(with_screenshots_subfolder + csv_file)
    ...
    for row in rows:   # create video
        ...
        csv_df.at[row, 'cold_email_video_url'] = export_output_url
        # write dataframe to csv 
        csv_df.to_csv(with_videos_subfolder + csv_file.replace(with_screenshots_suffix, with_videos_suffix), index = False)   
